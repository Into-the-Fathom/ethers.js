...
var provider = new ethersfathom_1.ethers.providers.InfuraProvider("rinkeby", "49a0efa3aaee4fd99797bfa94d8ce2f1");
//const provider = ethers.getDefaultProvider("rinkeby");
var TIMEOUT_PERIOD = 120000;
var contract = (function () {
    return new ethersfathom_1.ethers.Contract(test_contract_json_1.default.contractAddress, test_contract_json_1.default.interface, provider);
})();
function equals(name, actual, expected) {
    ...
    if (typeof (actual) === 'object') {
        if (expected.indexed) {
            assert_1.default.ok(ethersfathom_1.ethers.Contract.isIndexed(actual), 'index property has index - ' + name);
            if (expected.hash) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ethersfathom_1.ethers.utils.fetchJson('https://api.ethers.io/api/v1/?action=triggerTest&address=' + contract.address)];
                case 1:
                    data = _a.sent();
...
describe("Test Contract Transaction Population", function () {
    ...
    var contract = new ethersfathom_1.ethers.Contract(testAddress, abi);
    var contractConnected = contract.connect(ethersfathom_1.ethers.getDefaultProvider());
