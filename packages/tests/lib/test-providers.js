...
var bnify = ethersfathom_1.ethers.BigNumber.from;
var blockchainData = {
    homestead: {
        addresses: [
            {
...
function equals(name, actual, expected) {
    if (expected && expected.eq) {
        ...
        expected = ethersfathom_1.ethers.BigNumber.from(expected);
        actual = ethersfathom_1.ethers.BigNumber.from(actual);
...
function getApiKeys(network) {
    ...
    var apiKeys = ethersfathom_1.ethers.utils.shallowCopy(_ApiKeys);
...
var providerFunctions = [
    {
        ...
        create: function (network) {
            if (network == "default") {
                return ethersfathom_1.ethers.getDefaultProvider(null, getApiKeys(network));
            }
            return ethersfathom_1.ethers.getDefaultProvider(network, getApiKeys(network));
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new ethersfathom_1.ethers.providers.AlchemyProvider(null, getApiKeys(network).alchemy);
            }
            return new ethersfathom_1.ethers.providers.AlchemyProvider(network, getApiKeys(network).alchemy);
        }
    },
    {
        name: "AnkrProvider",
        ...
        create: function (network) {
            if (network == "default") {
                return new ethersfathom_1.ethers.providers.AnkrProvider(null);
            }
            return new ethersfathom_1.ethers.providers.AnkrProvider(network);
        }
    },
    /*
    {
    ...
    */
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new ethersfathom_1.ethers.providers.InfuraProvider(null, getApiKeys(network).infura);
            }
            return new ethersfathom_1.ethers.providers.InfuraProvider(network, getApiKeys(network).infura);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new ethersfathom_1.ethers.providers.EtherscanProvider(null, getApiKeys(network).etherscan);
            }
            return new ethersfathom_1.ethers.providers.EtherscanProvider(network, getApiKeys(network).etherscan);
        }
    },
    {
    ...
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new ethersfathom_1.ethers.providers.PocketProvider(null, {
                    applicationId: getApiKeys(network).pocket,
                    loadBalancer: true
                });
            }
            return new ethersfathom_1.ethers.providers.PocketProvider(network, {
                applicationId: getApiKeys(network).pocket,
                loadBalancer: true
            });
        }
...
var fundWallet = ethersfathom_1.ethers.Wallet.createRandom();
var testFunctions = [];
...
(function () {
    ...
    */
    ...
    addErrorTest(ethersfathom_1.ethers.utils.Logger.errors.NONCE_EXPIRED, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    addErrorTest(ethersfathom_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
    ...
    addErrorTest(ethersfathom_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wallet = ethersfathom_1.ethers.Wallet.createRandom().connect(provider);
            return [2 /*return*/, wallet.sendTransaction(txProps)];
        });
    }); });
    addErrorTest(ethersfathom_1.ethers.utils.Logger.errors.UNPREDICTABLE_GAS_LIMIT, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    execute: function (provider) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    b0 = _a.sent();
                    assert_1.default.ok(b0.gt(ethersfathom_1.ethers.constants.Zero), "balance is non-zero");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        provider = new ethersfathom_1.ethers.providers.InfuraProvider("ropsten", getApiKeys("ropsten").infura);
                        return [4 /*yield*/, ethersfathom_1.ethers.utils.fetchJson("https://api.ethers.io/api/v1/?action=fundAccount&address=" + fundWallet.address.toLowerCase())];
                    case 1:
                        funder = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        provider = new ethersfathom_1.ethers.providers.EtherscanProvider(null, getApiKeys(null).etherscan);
...
describe("Test Basic Authentication", function () {
    ...
    function test(name, url) {
        it("tests " + name, function () {
            this.timeout(60000);
            return ethersfathom_1.ethers.utils.fetchJson(url).then(function (data) {
    ...
    it("tests insecure connections fail", function () {
        ...
        assert_1.default.throws(function () {
            return ethersfathom_1.ethers.utils.fetchJson(insecure);
        }, function (error) {
...
describe("Test API Key Formatting", function () {
    it("Infura API Key", function () {
        ...
        var apiKeyString = ethersfathom_1.ethers.providers.InfuraProvider.getApiKey(projectId);
        ...
        var apiKeyObject = ethersfathom_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId
        });
        ...
        var apiKeyObject2 = ethersfathom_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId,
        ...
        assert_1.default.throws(function () {
            var apiKey = ethersfathom_1.ethers.providers.InfuraProvider.getApiKey({
                projectId: 1234,
                projectSecret: projectSecret
            });
            console.log(apiKey);
        ...
        {
            var provider = new ethersfathom_1.ethers.providers.InfuraProvider("homestead", {
                projectId: projectId,
                projectSecret: projectSecret
            });
        ...
        assert_1.default.throws(function () {
            var provider = new ethersfathom_1.ethers.providers.InfuraProvider("imaginary");
    ...
    it("Pocket API key", function () {
        ...
        var apiKeyString = ethersfathom_1.ethers.providers.PocketProvider.getApiKey(applicationId);
        ...
        var apiKeyObject = ethersfathom_1.ethers.providers.PocketProvider.getApiKey({
        ...
        var apiKeyObject2 = ethersfathom_1.ethers.providers.PocketProvider.getApiKey({
            applicationId: applicationId,
        ...
        // Test complex API key with loadBalancer
        {
            ...
            var apiKeyObject_1 = ethersfathom_1.ethers.providers.PocketProvider.getApiKey({
                applicationId: applicationId,
            ...
            var apiKeyObject2_1 = ethersfathom_1.ethers.providers.PocketProvider.getApiKey({
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey,
                loadBalancer: loadBalancer
            });
        ...
        {
            var provider = new ethersfathom_1.ethers.providers.PocketProvider("homestead", {
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey
            });
            assert_1.default.equal(provider.network.name, "homestead");
        ...
        // Attempt an unsupported network
        assert_1.default.throws(function () {
            var provider = new ethersfathom_1.ethers.providers.PocketProvider("imaginary");
            console.log(provider);
        }, function (error) {
            return (error.argument === "network" && error.reason === "unsupported network");
        });
    ...
    it("InfuraProvider.getWebSocketProvider", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = ethersfathom_1.ethers.providers.InfuraProvider.getWebSocketProvider();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        provider = new ethersfathom_1.ethers.providers.InfuraProvider("rinkeby");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        wallet = new ethersfathom_1.ethers.Wallet(ethersfathom_1.ethers.utils.id("random-wallet"), provider);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.timeout(60000);
                            provider = ethersfathom_1.ethers.getDefaultProvider("ropsten", getApiKeys("ropsten"));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.timeout(60000);
                            provider = ethersfathom_1.ethers.getDefaultProvider("homestead", getApiKeys("homestead"));
                            return [4 /*yield*/, provider.getAvatar(test.name)];
                        case 1:
                            avatar = _a.sent();
...
describe("Test CCIP execution", function () {
    ...
    var provider = providerFunctions[0].create("ropsten");
    var contract = new ethersfathom_1.ethers.Contract(address, ABI, provider);
    ...
    var verify = function (sender, data, result) {
        var check = ethersfathom_1.ethers.utils.concat([
            ethersfathom_1.ethers.utils.arrayify(ethersfathom_1.ethers.utils.arrayify(sender).length),
            sender,
            ethersfathom_1.ethers.utils.arrayify(ethersfathom_1.ethers.utils.arrayify(data).length),
            data
        ]);
        assert_1.default.equal(result, ethersfathom_1.ethers.utils.keccak256(check), "response is equal");
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contract = new ethersfathom_1.ethers.Contract(address, ABI, provider);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        data = "0x1234";
