...
describe('Test JSON Wallets', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (test.hasAddress) {
                                assert_1.default.ok((ethersfathom_1.ethers.utils.getJsonWalletAddress(test.json) !== null), 'detect encrypted JSON wallet');
                            }
                            return [4 /*yield*/, ethersfathom_1.ethers.Wallet.fromEncryptedJson(test.json, test.password)];
                        case 1:
                            wallet = _a.sent();
                        ...
                        case 2:
                            ...
                            // Test connect
                            {
                                provider = new ethersfathom_1.ethers.providers.EtherscanProvider();
                            ...
                            {
                                wallet2 = new ethersfathom_1.ethers.Wallet(wallet._signingKey());
                            ...
                            if (test.name === "life") {
                                wallet2 = ethersfathom_1.ethers.Wallet.fromEncryptedJsonSync(test.json, test.password);
                                assert_1.default.equal(wallet2.privateKey, test.privateKey, 'generated correct private key - ' + wallet2.privateKey);
                            }
                            if (test.mnemonic) {
    ...
    ['one', 'two', 'three'].forEach(function (i) {
        ...
        var wallet = ethersfathom_1.ethers.Wallet.createRandom({ path: "m/56'/82", extraEntropy: utils.randomHexString('test-' + i, 32) });
        it('encrypts and decrypts a random wallet - ' + i, function () {
            this.timeout(1200000);
            return wallet.encrypt(password).then(function (json) {
                return ethersfathom_1.ethers.Wallet.fromEncryptedJson(json, password).then(function (decryptedWallet) {
...
describe('Test Transaction Signing and Parsing', function () {
    function checkTransaction(parsedTransaction, test) {
        ...
        ['nonce', 'gasLimit', 'gasPrice', 'to', 'value', 'data'].forEach(function (key) {
            ...
            if (["gasLimit", "gasPrice", "value"].indexOf(key) >= 0) {
                assert_1.default.ok((ethersfathom_1.ethers.BigNumber.isBigNumber(value)), 'parsed into a big number - ' + key);
                ...
                value = ethersfathom_1.ethers.utils.hexlify(value);
                if (!expected || expected === '0x') {
                    expected = '0x00';
                }
            }
                ...
                if (value) {
                    ...
                    ethersfathom_1.ethers.utils.getAddress(value);
    ...
    tests.forEach(function (test) {
        it(('parses and signs transaction - ' + test.name), function () {
            this.timeout(120000);
            var signingKey = new ethersfathom_1.ethers.utils.SigningKey(test.privateKey);
            var signDigest = signingKey.signDigest.bind(signingKey);
            // Legacy parsing unsigned transaction
            checkTransaction(ethersfathom_1.ethers.utils.parseTransaction(test.unsignedTransaction), test);
            var parsedTransaction = ethersfathom_1.ethers.utils.parseTransaction(test.signedTransaction);
            var transaction = checkTransaction(parsedTransaction, test);
            // Legacy signed transaction ecrecover
            assert_1.default.equal(parsedTransaction.from, ethersfathom_1.ethers.utils.getAddress(test.accountAddress), 'computed from');
            ...
            (function () {
                var unsignedTx = ethersfathom_1.ethers.utils.serializeTransaction(transaction);
                ...
                var signature = signDigest(ethersfathom_1.ethers.utils.keccak256(unsignedTx));
                assert_1.default.equal(ethersfathom_1.ethers.utils.serializeTransaction(transaction, signature), test.signedTransaction, 'signs transaction (legacy)');
            })();
            // EIP155
            // EIP-155 parsing unsigned transaction
            var parsedUnsignedTransactionChainId5 = ethersfathom_1.ethers.utils.parseTransaction(test.unsignedTransactionChainId5);
            ...
            // EIP-155 fields
            var parsedTransactionChainId5 = ethersfathom_1.ethers.utils.parseTransaction(test.signedTransactionChainId5);
            ...
            (function () {
                ...
                var signature = signDigest(ethersfathom_1.ethers.utils.keccak256(unsignedTx));
                assert_1.default.equal(ethersfathom_1.ethers.utils.serializeTransaction(transaction, signature), test.signedTransactionChainId5, 'signs transaction (eip155)');
            })();
        });
    });
    tests.forEach(function (test) {
...
describe('Test Signing Messages', function () {
    var tests = [
        ...
        // See: https://github.com/Into-the-Fathom/ethers.js/issues/80
        {
            ...
            message: ethersfathom_1.ethers.utils.arrayify('0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad'),
        ...
        // See: https://github.com/Into-the-Fathom/ethers.js/issues/85
        {
            ...
            message: ethersfathom_1.ethers.utils.arrayify(ethersfathom_1.ethers.utils.id('0x7f23b5eed5bc7e89f267f339561b2697faab234a2')),
    ...
    tests.forEach(function (test) {
        it(('signs a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var wallet = new ethersfathom_1.ethers.Wallet(test.privateKey);
    ...
    tests.forEach(function (test) {
        it(('verifies a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var address = ethersfathom_1.ethers.utils.verifyMessage(test.message, test.signature);
    ...
    tests.forEach(function (test) {
        it(('hashes a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var hash = ethersfathom_1.ethers.utils.hashMessage(test.message);
...
describe("Serialize Transactions", function () {
    it("allows odd-length numeric values", function () {
        ethersfathom_1.ethers.utils.serializeTransaction({
            gasLimit: "0x1",
            gasPrice: "0x1",
            value: "0x1"
        });
...
describe("Wallet Errors", function () {
    it("fails on privateKey/address mismatch", function () {
        assert_1.default.throws(function () {
            var wallet = new ethersfathom_1.ethers.Wallet({
    ...
    it("fails on from mismatch", function () {
        var _this = this;
        var wallet = new ethersfathom_1.ethers.Wallet("0x6a73cd9b03647e83ef937888a5258a26e4c766dbf41ddd974f15e32d09cfe9c0");
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1.code === ethersfathom_1.ethers.utils.Logger.errors.INVALID_ARGUMENT && error_1.argument === "transaction.from") {
                            resolve(true);
                            return [2 /*return*/];
                        }
                        return [3 /*break*/, 3];
