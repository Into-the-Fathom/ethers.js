...
var LedgerSigner = /** @class */ (function (_super) {
    ...
    function LedgerSigner(provider, type, path) {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "path", path);
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "type", type);
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "provider", provider || null);
        var transport = ledger_transport_1.transports[type];
        if (!transport) {
            logger.throwArgumentError("unknown or unsupported type", "type", type);
        }
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "_eth", transport.create().then(function (transport) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        account = _a.sent();
                        return [2 /*return*/, ethersfathom_1.ethers.utils.getAddress(account.address)];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    case 0:
                        if (typeof (message) === 'string') {
                            message = ethersfathom_1.ethers.utils.toUtf8Bytes(message);
                        }
                        messageHex = ethersfathom_1.ethers.utils.hexlify(message).substring(2);
                        return [4 /*yield*/, this._retry(function (eth) { return eth.signPersonalMessage(_this.path, messageHex); })];
                    case 1:
                        sig = _a.sent();
                        sig.r = '0x' + sig.r;
                        sig.s = '0x' + sig.s;
                        return [2 /*return*/, ethersfathom_1.ethers.utils.joinSignature(sig)];
                }
            });
        });
    };
    LedgerSigner.prototype.signTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ethersfathom_1.ethers.utils.resolveProperties(transaction)];
                    case 1:
                        tx = _a.sent();
                        baseTx = {
                            ...
                            nonce: (tx.nonce ? ethersfathom_1.ethers.BigNumber.from(tx.nonce).toNumber() : undefined),
                            to: (tx.to || undefined),
                            value: (tx.value || undefined),
                        };
                        unsignedTx = ethersfathom_1.ethers.utils.serializeTransaction(baseTx).substring(2);
                        return [4 /*yield*/, this._retry(function (eth) { return eth.signTransaction(_this.path, unsignedTx); })];
                    case 2:
                        sig = _a.sent();
                        return [2 /*return*/, ethersfathom_1.ethers.utils.serializeTransaction(baseTx, {
                                v: ethersfathom_1.ethers.BigNumber.from("0x" + sig.v).toNumber(),
                                r: ("0x" + sig.r),
                                s: ("0x" + sig.s),
                            })];
                }
