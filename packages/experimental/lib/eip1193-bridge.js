...
var Eip1193Bridge = /** @class */ (function (_super) {
    ...
    function Eip1193Bridge(signer, provider) {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "signer", signer);
    ...
    Eip1193Bridge.prototype.send = function (method, params) {
        return __awaiter(this, void 0, void 0, function () {
            function throwUnsupported(message) {
                return logger.throwError(message, ethersfathom_1.ethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {
                    method: method,
                    params: params
                });
            }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        result = _b.sent();
                        return [2 /*return*/, ethersfathom_1.ethers.utils.hexValue(result.chainId)];
                    ...
                    case 14:
                        result = _b.sent();
                        return [2 /*return*/, ethersfathom_1.ethers.utils.hexValue(result)];
                    case 15: return [4 /*yield*/, this.provider.getBlock(params[0])];
                    case 16:
                        result = _b.sent();
                        return [2 /*return*/, ethersfathom_1.ethers.utils.hexValue(result.transactions.length)];
                    ...
                    case 21:
                        req = ethersfathom_1.ethers.providers.JsonRpcProvider.hexlifyTransaction(params[0]);
                    ...
                    case 34:
                        address = _b.sent();
                        if (address !== ethersfathom_1.ethers.utils.getAddress(params[0])) {
                            logger.throwArgumentError("account mismatch or account not found", "params[0]", params[0]);
                        }
                        return [2 /*return*/, this.signer.signMessage(ethersfathom_1.ethers.utils.arrayify(params[1]))];
                    case 35:
                        if (!this.signer) {
                    ...
                    case 37:
                        {
                            coerce = ethersfathom_1.ethers.utils.hexValue;
                            return [3 /*break*/, 39];
                        }
                        _b.label = 38;
