...
var basex_1 = require("@baldyash/basex");
...
var EnsPlugin = /** @class */ (function (_super) {
    ...
    function EnsPlugin() {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "_ethAddressCache", {});
        return _this;
    }
    EnsPlugin.prototype.getEns = function () {
        return new ethersfathom_1.ethers.Contract(this.network.ensAddress, ensAbi, this.accounts[0] || this.provider);
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a[_b] = _c.sent();
                        _c.label = 2;
                    case 2: return [2 /*return*/, new ethersfathom_1.ethers.Contract(this._ethAddressCache[nodehash], resolverAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getEthInterfaceAddress = function (interfaceId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ethNodehash = ethersfathom_1.ethers.utils.namehash("eth");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new ethersfathom_1.ethers.Contract(address, ethControllerAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new ethersfathom_1.ethers.Contract(address, ethLegacyRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getEthRegistrar = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getEns().owner(ethersfathom_1.ethers.utils.namehash("eth"))];
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new ethersfathom_1.ethers.Contract(address, ethRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        nodehash = ethersfathom_1.ethers.utils.namehash(name_1);
                                        details = {
                                            Nodehash: nodehash
                                        };
                                    ...
                                    case 1:
                                        ...
                                        if (!(owner === ethersfathom_1.ethers.constants.AddressZero)) return [3 /*break*/, 2];
                                        owner = null;
                                        return [3 /*break*/, 4];
                                    case 2:
                                        ...
                                        return [4 /*yield*/, ens.resolver(nodehash).then(function (address) {
                                                if (address === ethersfathom_1.ethers.constants.AddressZero) {
                                    ...
                                    case 4:
                                        ...
                                        details.Labelhash = ethersfathom_1.ethers.utils.id(comps[0].toLowerCase()); // @TODO: nameprep
                                        _c = details;
                                    ...
                                    case 7:
                                        ownerOf = _g.sent();
                                        if (ownerOf !== ethersfathom_1.ethers.constants.AddressZero) {
                                    ...
                                    case 9:
                                        entry = _g.sent();
                                        deed = new ethersfathom_1.ethers.Contract(entry.owner, deedAbi, this_1.provider);
                                        _d = details;
                                        return [4 /*yield*/, deed.owner()];
                                    case 10:
                                        _d.Registrant = _g.sent();
                                        details.Registrar = "Legacy";
                                        details["Deed Value"] = (ethersfathom_1.ethers.utils.formatEther(entry.value) + " ether");
                                        details["Highest Bid"] = (ethersfathom_1.ethers.utils.formatEther(entry.highestBid) + " ether");
                                        return [3 /*break*/, 11];
                                    case 11:
                                        if (!resolverAddress) return [3 /*break*/, 16];
                                        resolver = new ethersfathom_1.ethers.Contract(resolverAddress, resolverAbi, this_1.provider);
                                        _e = details;
                                        _f = "Address";
                                    ...
                                    case 14:
                                        ...
                                        return [4 /*yield*/, resolver.contenthash(nodehash).then(function (hash) {
                                                ...
                                                if (hash.substring(0, 10) === "0xe3010170" && ethersfathom_1.ethers.utils.isHexString(hash, 38)) {
                                                    return basex_1.Base58.encode(ethersfathom_1.ethers.utils.hexDataSlice(hash, 4)) + " (IPFS)";
                                                }
...
var AccountPlugin = /** @class */ (function (_super) {
    ...
    AccountPlugin.getHelp = function () {
        return logger.throwError("subclasses must implement this", ethersfathom_1.ethers.errors.UNSUPPORTED_OPERATION, {
            operation: "getHelp"
        });
    };
    AccountPlugin.prototype._setValue = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ethersfathom_1.ethers.utils.defineReadOnly(this, key, value);
                        if (!(key === "name")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._setValue("nodehash", ethersfathom_1.ethers.utils.namehash(value))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        helpLine = ethersfathom_1.ethers.utils.getStatic(this.constructor, "getHelp")().name;
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (secret) {
                            ...
                            this.salt = ethersfathom_1.ethers.utils.id(secret);
                        }
                    ...
                    case 5:
                        ...
                        ethersfathom_1.ethers.utils.defineReadOnly(this, "duration", duration * (60 * 60 * 24));
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        signature = _a.sent();
                        this.salt = ethersfathom_1.ethers.utils.keccak256(signature);
                        _a.label = 3;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        this.dump("Commit: " + this.name, {
                            ...
                            Fee: ethersfathom_1.ethers.utils.formatEther(fee) + " (informational)",
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.dump("Reveal: " + this.name, {
                            ...
                            Fee: ethersfathom_1.ethers.utils.formatEther(fee),
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getEns().setSubnodeOwner(ethersfathom_1.ethers.utils.namehash(this.node), ethersfathom_1.ethers.utils.id(this.label), this.address)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        nodehash = ethersfathom_1.ethers.utils.namehash(this.address.substring(2) + ".addr.reverse");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        multihash = ethersfathom_1.ethers.utils.concat(["0xe3010170", bytes]);
                        return [4 /*yield*/, _super.prototype._setValue.call(this, "multihash", ethersfathom_1.ethers.utils.hexlify(multihash))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, _super.prototype._setValue.call(this, key, value)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, ethLegacyRegistrar.entries(ethersfathom_1.ethers.utils.id(comps[0]))];
                    case 4:
                        entry = _a.sent();
                        ...
                        deed = new ethersfathom_1.ethers.Contract(entry.owner, deedAbi, this.provider);
                        return [4 /*yield*/, deed.owner()];
                    case 5:
                        owner = _a.sent();
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Migrate Registrar: " + this.name, {
                            "Nodehash": this.nodehash,
                            "Highest Bid": (ethersfathom_1.ethers.utils.formatEther(this.highestBid) + " ether"),
                            "Deed Value": (ethersfathom_1.ethers.utils.formatEther(this.deedValue) + " ether"),
                        });
                        return [4 /*yield*/, this.getEthLegacyRegistrar()];
                    case 2:
                        legacyRegistrar = _a.sent();
                        return [4 /*yield*/, legacyRegistrar.transferRegistrars(ethersfathom_1.ethers.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.safeTransferFrom(this.accounts[0].getAddress(), this.new_owner, ethersfathom_1.ethers.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, registrar.ownerOf(ethersfathom_1.ethers.utils.id(comps[0]))];
                    case 4:
                        ownerOf = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.reclaim(ethersfathom_1.ethers.utils.id(this.label), this.address)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        label = this.labels[i];
                        console.log(label);
                        return [4 /*yield*/, ethRegistrar.nameExpires(ethersfathom_1.ethers.utils.id(label))];
                    case 5:
                    ...
                    case 6:
                        ...
                        this.dump("Renew: " + label + ".eth", {
                            ...
                            "Fee": ethersfathom_1.ethers.utils.formatEther(fee) + " (+10% buffer)",
                        });
