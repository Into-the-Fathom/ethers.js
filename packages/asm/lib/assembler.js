...
function hexConcat(values) {
    return fathom_ethers_1.ethers.utils.hexlify(fathom_ethers_1.ethers.utils.concat(values.map(function (v) {
        if (v instanceof opcodes_1.Opcode) {
            return [v.value];
        }
        if (typeof (v) === "number") {
            if (v >= 0 && v <= 255 && !(v % 1)) {
                return fathom_ethers_1.ethers.utils.hexlify(v);
            }
            else {
...
var Script = /** @class */ (function () {
    function Script(filename, callback) {
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "filename", filename);
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "contextObject", this._baseContext(callback));
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "context", vm_1.default.createContext(this.contextObject));
    }
    Script.prototype._baseContext = function (callback) {
        ...
        return new Proxy({
            ...
            ethers: fathom_ethers_1.ethers,
            utils: fathom_ethers_1.ethers.utils,
            BigNumber: fathom_ethers_1.ethers.BigNumber,
            arrayify: fathom_ethers_1.ethers.utils.arrayify,
            concat: hexConcat,
            hexlify: fathom_ethers_1.ethers.utils.hexlify,
            zeroPad: function (value, length) {
                return fathom_ethers_1.ethers.utils.hexlify(fathom_ethers_1.ethers.utils.zeroPad(value, length));
            },
            id: fathom_ethers_1.ethers.utils.id,
            keccak256: fathom_ethers_1.ethers.utils.keccak256,
            namehash: fathom_ethers_1.ethers.utils.namehash,
            sha256: fathom_ethers_1.ethers.utils.sha256,
            parseEther: fathom_ethers_1.ethers.utils.parseEther,
            formatEther: fathom_ethers_1.ethers.utils.formatEther,
            parseUnits: fathom_ethers_1.ethers.utils.parseUnits,
            formatUnits: fathom_ethers_1.ethers.utils.formatUnits,
            randomBytes: function (length) {
                return fathom_ethers_1.ethers.utils.hexlify(fathom_ethers_1.ethers.utils.randomBytes(length));
            },
            toUtf8Bytes: fathom_ethers_1.ethers.utils.toUtf8Bytes,
            toUtf8String: fathom_ethers_1.ethers.utils.toUtf8String,
            formatBytes32String: fathom_ethers_1.ethers.utils.formatBytes32String,
            parseBytes32String: fathom_ethers_1.ethers.utils.parseBytes32String,
            Opcode: opcodes_1.Opcode,
            sighash: function (signature) {
                return fathom_ethers_1.ethers.utils.id(fathom_ethers_1.ethers.utils.FunctionFragment.from(signature).format()).substring(0, 10);
            },
            topichash: function (signature) {
                return fathom_ethers_1.ethers.utils.id(fathom_ethers_1.ethers.utils.EventFragment.from(signature).format());
            },
            assemble: assemble,
...
var Node = /** @class */ (function () {
    function Node(guard, location, options) {
        ...
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "location", Object.freeze(location));
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "tag", "node-" + nextTag++ + "-" + this.constructor.name);
        for (var key in options) {
            fathom_ethers_1.ethers.utils.defineReadOnly(this, key, options[key]);
        }
    }
...
var ValueNode = /** @class */ (function (_super) {
    ...
    ValueNode.prototype.getPushLiteral = function (value) {
        ...
        var hex = fathom_ethers_1.ethers.utils.hexlify(value);
        if (hex === "0x") {
            throwError("invalid literal: 0x", this.location);
        }
        // Make sure it will fit into a push
        var length = fathom_ethers_1.ethers.utils.hexDataLength(hex);
            ...
            return __generator(this, function (_a) {
                ...
                if (this.verbatim) {
                    if (this.value.substring(0, 2) === "0x") {
                        ...
                        visit(this, fathom_ethers_1.ethers.BigNumber.from(this.value).toHexString());
                    }
                }
                else {
                    visit(this, this.getPushLiteral(fathom_ethers_1.ethers.BigNumber.from(this.value)));
                }
                assembler.end(this);
                return [2 /*return*/];
            });
                ...
                if (isOffset && assembler.positionIndependentCode) {
                    ...
                    if (here > value) {
                        ...
                        for (w = 1; w <= 5; w++) {
                            ...
                            if (fathom_ethers_1.ethers.utils.hexDataLength(literal) <= w) {
                                literal = fathom_ethers_1.ethers.utils.hexZeroPad(literal, w);
                                break;
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Append this opcode
                        visit(this, fathom_ethers_1.ethers.utils.hexlify(this.opcode.value));
                        assembler.end(this);
                        return [2 /*return*/];
                }
            });
...
var LabelledNode = /** @class */ (function (_super) {
    ...
    function LabelledNode(guard, location, name, values) {
        ...
        values = fathom_ethers_1.ethers.utils.shallowCopy(values || {});
        values.name = name;
...
var LabelNode = /** @class */ (function (_super) {
    ...
    LabelNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assembler.start(this);
                visit(this, fathom_ethers_1.ethers.utils.hexlify(opcodes_1.Opcode.from("JUMPDEST").value));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
    ...
    PaddingNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                padding.fill(0);
                visit(this, fathom_ethers_1.ethers.utils.hexlify(padding));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data) {
        ...
        fathom_ethers_1.ethers.utils.defineReadOnly(_this, "padding", new PaddingNode(Guard, _this.location));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        bytecode = fathom_ethers_1.ethers.utils.concat(this.data.map(function (d) { return assembler.getBytecode(d); }));
                        i = 0;
                    ...
                    case 1:
                        ...
                        if (this.verbatim) {
                            if (typeof (result) === "number") {
                                visit(this, fathom_ethers_1.ethers.BigNumber.from(result).toHexString());
                            }
                            else {
                                visit(this, fathom_ethers_1.ethers.utils.hexlify(result));
                            }
                        }
                        else {
...
function disassemble(bytecode) {
    var ops = [];
    var offsets = {};
    var bytes = fathom_ethers_1.ethers.utils.arrayify(bytecode, { allowMissingPrefix: true });
    var i = 0;
    var oob = false;
    while (i < bytes.length) {
        var opcode = opcodes_1.Opcode.from(bytes[i]);
        if (!opcode) {
            opcode = new opcodes_1.Opcode("unknown (" + fathom_ethers_1.ethers.utils.hexlify(bytes[i]) + ")", bytes[i], 0, 0);
        }
        ...
        if (push) {
            var data = fathom_ethers_1.ethers.utils.hexlify(bytes.slice(i, i + push));
            if (fathom_ethers_1.ethers.utils.hexDataLength(data) === push) {
                op.pushValue = data;
                op.length += push;
                i += push;
            }
    ...
    ops.getBytes = function (offset, length) {
        ...
        return fathom_ethers_1.ethers.utils.arrayify(result);
    };
...
function formatBytecode(bytecode) {
    ...
    bytecode.forEach(function (op) {
        ...
        var offset = fathom_ethers_1.ethers.utils.hexZeroPad(fathom_ethers_1.ethers.utils.hexlify(op.offset), 2);
...
var Assembler = /** @class */ (function () {
    function Assembler(root, positionIndependentCode) {
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "root", root);
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "positionIndependentCode", !!positionIndependentCode);
        var nodes = {};
        var labels = {};
        var parents = {};
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), fathom_ethers_1.ethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), fathom_ethers_1.ethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
        ...
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "labels", Object.freeze(labels));
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "nodes", Object.freeze(nodes));
        fathom_ethers_1.ethers.utils.defineReadOnly(this, "_parents", Object.freeze(parents));
    }
    // Link operations
    ...
    Assembler.prototype.getLinkValue = function (target, source) {
        ...
        var bytes = Array.prototype.slice.call(fathom_ethers_1.ethers.utils.arrayify(info.bytecode));
        fathom_ethers_1.ethers.utils.defineReadOnly(bytes, "ast", target);
        fathom_ethers_1.ethers.utils.defineReadOnly(bytes, "source", target.location.source);
        ...
        if (!safeOffset) {
            ...
            fathom_ethers_1.ethers.utils.defineReadOnly(bytes, "_freeze", function () { });
        }
        ...
        if (safeOffset) {
            ...
            fathom_ethers_1.ethers.utils.defineReadOnly(bytes, "_freeze", function () {
                ...
                frozen_1 = true;
                fathom_ethers_1.ethers.utils.defineReadOnly(bytes, "offset", bytes.offset);
            });
        }
        return bytes;
    };
...
var CodeGenerationAssembler = /** @class */ (function (_super) {
    ...
    function CodeGenerationAssembler(root, options) {
        ...
        fathom_ethers_1.ethers.utils.defineReadOnly(_this, "retry", ((options.retry != null) ? options.retry : 512));
        fathom_ethers_1.ethers.utils.defineReadOnly(_this, "filename", (0, path_1.resolve)(options.filename || "./contract.asm"));
        fathom_ethers_1.ethers.utils.defineReadOnly(_this, "defines", Object.freeze(options.defines || {}));
        fathom_ethers_1.ethers.utils.defineReadOnly(_this, "_stack", []);
        _this.reset();
        return _this;
    }
        ...
        try {
            if (result.offset < 0) {
                ...
                this._checks.push(function () {
                    ...
                    if (check.offset === result.offset && fathom_ethers_1.ethers.utils.hexlify(check) === fathom_ethers_1.ethers.utils.hexlify(result)) {
                        return true;
                    }
                    return false;
                });
            ...
            this._checks.push(function () {
                var check = _super.prototype.getLinkValue.call(_this, target, source);
                return (fathom_ethers_1.ethers.utils.hexlify(check) === fathom_ethers_1.ethers.utils.hexlify(result));
            });
        }
        return result;
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.root.assemble(this, function (node, bytecode) {
                                ...
                                offset += fathom_ethers_1.ethers.utils.hexDataLength(bytecode);
                            })];
                    case 1:
                        _a.sent();
                        this._runChecks();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, logger.throwError("unable to assemble; " + this.retry + " attempts failed to generate stable bytecode", fathom_ethers_1.ethers.utils.Logger.errors.UNKNOWN_ERROR, {})];
                }
            });
        });
    };
