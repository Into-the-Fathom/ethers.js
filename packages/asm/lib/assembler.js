...
function hexConcat(values) {
    return ethersfathom_1.ethers.utils.hexlify(ethersfathom_1.ethers.utils.concat(values.map(function (v) {
        if (v instanceof opcodes_1.Opcode) {
            return [v.value];
        }
        if (typeof (v) === "number") {
            if (v >= 0 && v <= 255 && !(v % 1)) {
                return ethersfathom_1.ethers.utils.hexlify(v);
            }
            else {
...
var Script = /** @class */ (function () {
    function Script(filename, callback) {
        ethersfathom_1.ethers.utils.defineReadOnly(this, "filename", filename);
        ethersfathom_1.ethers.utils.defineReadOnly(this, "contextObject", this._baseContext(callback));
        ethersfathom_1.ethers.utils.defineReadOnly(this, "context", vm_1.default.createContext(this.contextObject));
    }
    Script.prototype._baseContext = function (callback) {
        ...
        return new Proxy({
            ...
            ethers: ethersfathom_1.ethers,
            utils: ethersfathom_1.ethers.utils,
            BigNumber: ethersfathom_1.ethers.BigNumber,
            arrayify: ethersfathom_1.ethers.utils.arrayify,
            concat: hexConcat,
            hexlify: ethersfathom_1.ethers.utils.hexlify,
            zeroPad: function (value, length) {
                return ethersfathom_1.ethers.utils.hexlify(ethersfathom_1.ethers.utils.zeroPad(value, length));
            },
            id: ethersfathom_1.ethers.utils.id,
            keccak256: ethersfathom_1.ethers.utils.keccak256,
            namehash: ethersfathom_1.ethers.utils.namehash,
            sha256: ethersfathom_1.ethers.utils.sha256,
            parseEther: ethersfathom_1.ethers.utils.parseEther,
            formatEther: ethersfathom_1.ethers.utils.formatEther,
            parseUnits: ethersfathom_1.ethers.utils.parseUnits,
            formatUnits: ethersfathom_1.ethers.utils.formatUnits,
            randomBytes: function (length) {
                return ethersfathom_1.ethers.utils.hexlify(ethersfathom_1.ethers.utils.randomBytes(length));
            },
            toUtf8Bytes: ethersfathom_1.ethers.utils.toUtf8Bytes,
            toUtf8String: ethersfathom_1.ethers.utils.toUtf8String,
            formatBytes32String: ethersfathom_1.ethers.utils.formatBytes32String,
            parseBytes32String: ethersfathom_1.ethers.utils.parseBytes32String,
            Opcode: opcodes_1.Opcode,
            sighash: function (signature) {
                return ethersfathom_1.ethers.utils.id(ethersfathom_1.ethers.utils.FunctionFragment.from(signature).format()).substring(0, 10);
            },
            topichash: function (signature) {
                return ethersfathom_1.ethers.utils.id(ethersfathom_1.ethers.utils.EventFragment.from(signature).format());
            },
            assemble: assemble,
...
var Node = /** @class */ (function () {
    function Node(guard, location, options) {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(this, "location", Object.freeze(location));
        ethersfathom_1.ethers.utils.defineReadOnly(this, "tag", "node-" + nextTag++ + "-" + this.constructor.name);
        for (var key in options) {
            ethersfathom_1.ethers.utils.defineReadOnly(this, key, options[key]);
        }
    }
...
var ValueNode = /** @class */ (function (_super) {
    ...
    ValueNode.prototype.getPushLiteral = function (value) {
        ...
        var hex = ethersfathom_1.ethers.utils.hexlify(value);
        if (hex === "0x") {
            throwError("invalid literal: 0x", this.location);
        }
        // Make sure it will fit into a push
        var length = ethersfathom_1.ethers.utils.hexDataLength(hex);
            ...
            return __generator(this, function (_a) {
                ...
                if (this.verbatim) {
                    if (this.value.substring(0, 2) === "0x") {
                        ...
                        visit(this, ethersfathom_1.ethers.BigNumber.from(this.value).toHexString());
                    }
                }
                else {
                    visit(this, this.getPushLiteral(ethersfathom_1.ethers.BigNumber.from(this.value)));
                }
                assembler.end(this);
                return [2 /*return*/];
            });
                ...
                if (isOffset && assembler.positionIndependentCode) {
                    ...
                    if (here > value) {
                        ...
                        for (w = 1; w <= 5; w++) {
                            ...
                            if (ethersfathom_1.ethers.utils.hexDataLength(literal) <= w) {
                                literal = ethersfathom_1.ethers.utils.hexZeroPad(literal, w);
                                break;
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Append this opcode
                        visit(this, ethersfathom_1.ethers.utils.hexlify(this.opcode.value));
                        assembler.end(this);
                        return [2 /*return*/];
                }
            });
...
var LabelledNode = /** @class */ (function (_super) {
    ...
    function LabelledNode(guard, location, name, values) {
        ...
        values = ethersfathom_1.ethers.utils.shallowCopy(values || {});
        values.name = name;
...
var LabelNode = /** @class */ (function (_super) {
    ...
    LabelNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assembler.start(this);
                visit(this, ethersfathom_1.ethers.utils.hexlify(opcodes_1.Opcode.from("JUMPDEST").value));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
    ...
    PaddingNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                padding.fill(0);
                visit(this, ethersfathom_1.ethers.utils.hexlify(padding));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data) {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "padding", new PaddingNode(Guard, _this.location));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        bytecode = ethersfathom_1.ethers.utils.concat(this.data.map(function (d) { return assembler.getBytecode(d); }));
                        i = 0;
                    ...
                    case 1:
                        ...
                        if (this.verbatim) {
                            if (typeof (result) === "number") {
                                visit(this, ethersfathom_1.ethers.BigNumber.from(result).toHexString());
                            }
                            else {
                                visit(this, ethersfathom_1.ethers.utils.hexlify(result));
                            }
                        }
                        else {
...
function disassemble(bytecode) {
    var ops = [];
    var offsets = {};
    var bytes = ethersfathom_1.ethers.utils.arrayify(bytecode, { allowMissingPrefix: true });
    var i = 0;
    var oob = false;
    while (i < bytes.length) {
        var opcode = opcodes_1.Opcode.from(bytes[i]);
        if (!opcode) {
            opcode = new opcodes_1.Opcode("unknown (" + ethersfathom_1.ethers.utils.hexlify(bytes[i]) + ")", bytes[i], 0, 0);
        }
        ...
        if (push) {
            var data = ethersfathom_1.ethers.utils.hexlify(bytes.slice(i, i + push));
            if (ethersfathom_1.ethers.utils.hexDataLength(data) === push) {
                op.pushValue = data;
                op.length += push;
                i += push;
            }
    ...
    ops.getBytes = function (offset, length) {
        ...
        return ethersfathom_1.ethers.utils.arrayify(result);
    };
...
function formatBytecode(bytecode) {
    ...
    bytecode.forEach(function (op) {
        ...
        var offset = ethersfathom_1.ethers.utils.hexZeroPad(ethersfathom_1.ethers.utils.hexlify(op.offset), 2);
...
var Assembler = /** @class */ (function () {
    function Assembler(root, positionIndependentCode) {
        ethersfathom_1.ethers.utils.defineReadOnly(this, "root", root);
        ethersfathom_1.ethers.utils.defineReadOnly(this, "positionIndependentCode", !!positionIndependentCode);
        var nodes = {};
        var labels = {};
        var parents = {};
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), ethersfathom_1.ethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), ethersfathom_1.ethers.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(this, "labels", Object.freeze(labels));
        ethersfathom_1.ethers.utils.defineReadOnly(this, "nodes", Object.freeze(nodes));
        ethersfathom_1.ethers.utils.defineReadOnly(this, "_parents", Object.freeze(parents));
    }
    // Link operations
    ...
    Assembler.prototype.getLinkValue = function (target, source) {
        ...
        var bytes = Array.prototype.slice.call(ethersfathom_1.ethers.utils.arrayify(info.bytecode));
        ethersfathom_1.ethers.utils.defineReadOnly(bytes, "ast", target);
        ethersfathom_1.ethers.utils.defineReadOnly(bytes, "source", target.location.source);
        ...
        if (!safeOffset) {
            ...
            ethersfathom_1.ethers.utils.defineReadOnly(bytes, "_freeze", function () { });
        }
        ...
        if (safeOffset) {
            ...
            ethersfathom_1.ethers.utils.defineReadOnly(bytes, "_freeze", function () {
                ...
                frozen_1 = true;
                ethersfathom_1.ethers.utils.defineReadOnly(bytes, "offset", bytes.offset);
            });
        }
        return bytes;
    };
...
var CodeGenerationAssembler = /** @class */ (function (_super) {
    ...
    function CodeGenerationAssembler(root, options) {
        ...
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "retry", ((options.retry != null) ? options.retry : 512));
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "filename", (0, path_1.resolve)(options.filename || "./contract.asm"));
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "defines", Object.freeze(options.defines || {}));
        ethersfathom_1.ethers.utils.defineReadOnly(_this, "_stack", []);
        _this.reset();
        return _this;
    }
        ...
        try {
            if (result.offset < 0) {
                ...
                this._checks.push(function () {
                    ...
                    if (check.offset === result.offset && ethersfathom_1.ethers.utils.hexlify(check) === ethersfathom_1.ethers.utils.hexlify(result)) {
                        return true;
                    }
                    return false;
                });
            ...
            this._checks.push(function () {
                var check = _super.prototype.getLinkValue.call(_this, target, source);
                return (ethersfathom_1.ethers.utils.hexlify(check) === ethersfathom_1.ethers.utils.hexlify(result));
            });
        }
        return result;
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.root.assemble(this, function (node, bytecode) {
                                ...
                                offset += ethersfathom_1.ethers.utils.hexDataLength(bytecode);
                            })];
                    case 1:
                        _a.sent();
                        this._runChecks();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, logger.throwError("unable to assemble; " + this.retry + " attempts failed to generate stable bytecode", ethersfathom_1.ethers.utils.Logger.errors.UNKNOWN_ERROR, {})];
                }
            });
        });
    };
