...
function _getIssues(user, password) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let issues = yield fetchGitHub(user, password, "https:/\/api.github.com/repos/Into-the-Fathom/ethers.js/issues?state=all&per_page=100", cacheOnly);
        if (!cacheOnly) {
...
function createRelease(user, password, tagName, title, body, prerelease, commit) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield (0, geturl_1.getUrl)("https:/\/api.github.com/repos/Into-the-Fathom/ethers.js/releases", {
